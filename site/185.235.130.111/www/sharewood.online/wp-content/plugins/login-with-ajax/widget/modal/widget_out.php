...
?>
	<div class="lwa lwa-template-modal"><?php //class must be here, and if this is a template, class name should be that of template directory ?>
		<a href="<?php echo esc_attr(LoginWithAjax::$url_login); ?>" class="lwa-links-modal"><?php esc_html_e('Войти','login-with-ajax') ?></a>
		<?php 
 ...
 <form name="lwa-form" class="lwa-form" action="<?php echo esc_attr(LoginWithAjax::$url_login); ?>" method="post">
	            ...
	            <div>
	                ...
	                <div class="lwa-submit">
	                    <div class="lwa-submit-button">
	                        <input type="submit" name="wp-submit" class="lwa-wp-submit" value="<?php esc_attr_e('Выполнить вход','login-with-ajax'); ?>" tabindex="100" />
                    ...
                    <?php echo get_ulogin_panel(); ?>
                        ...
                        <div class="links-f lf-l">
							<a class="lwa-links-remember" href="<?php echo esc_attr(LoginWithAjax::$url_remember); ?>" title="<?php esc_attr_e('Забыли пароль?','login-with-ajax') ?>"><?php esc_attr_e('Lost your password?','login-with-ajax') ?></a>
                        </div>
                        ...
                        <div class="links-f lf-r">
							Нет аккаунта? <a href="<?php echo esc_attr(LoginWithAjax::$url_register); ?>" class="lwa-links-register-inline"><?php esc_html_e('Зарегистрировать','login-with-ajax'); ?></a>
                        </div>
      ...
      <br>
	        ...
	        <form name="lwa-remember" class="lwa-remember" style="margin-top: 20px;" action="<?php echo esc_attr(LoginWithAjax::$url_remember); ?>" method="post" style="display:none;">
	        	<span class="lwa-status"></span>
	            <div>
	                <div>
	                    <div>
