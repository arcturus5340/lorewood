...
with open('templates/popular_records_template.html', 'w') as template:
    ...
    print('                <div class="row post-sidebar-cropped post-sidebar-overlay" style="margin: 0; background: url(\'{}\')no-repeat;background-size: cover;">'.format(popular_records[1][4]), file=template)
    ...
    print('                <div class="row post-sidebar-cropped post-sidebar-overlay" style="margin: 0; background: url({})no-repeat;background-size: cover;">'.format(popular_records[4][4]), file=template)
    print('                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">', file=template)
    print('                        <div class="post-wrap-sidebar">', file=template)
